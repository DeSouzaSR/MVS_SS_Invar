...
@NOXTICS; @YTICS
@TMARGIN; @LMARGIN
plot for [i=1:n_clones] filename(i, "Mercury")  u 1:3  w l notitle
# --- GRAPH b
set label 1 'Venus' @POS
@NOXTICS; @NOYTICS
@TMARGIN; @RMARGIN
plot for [i=1:n_clones] filename(i, "Venus")    u 1:3  w l notitle
# --- GRAPH c
set label 1 'Earth' @POS
@NOXTICS; @YTICS
@M1MARGIN; @LMARGIN
plot for [i=1:n_clones] filename(i, "Earth")    u 1:3  w l notitle
# --- GRAPH d
set label 1 'Mars' @POS
@NOXTICS; @NOYTICS
@M1MARGIN; @RMARGIN
plot for [i=1:n_clones] filename(i, "Mars")     u 1:3  w l notitle
# --- GRAPH e
set label 1 'Jupiter' @POS
@NOXTICS; @YTICS
@M2MARGIN; @LMARGIN
plot for [i=1:n_clones] filename(i, "Jupiter")  u 1:3  w l notitle
# --- GRAPH f
set label 1 'Saturn' @POS
@NOXTICS; @NOYTICS
@M2MARGIN; @RMARGIN
plot for [i=1:n_clones] filename(i, "Saturn")    u 1:3  w l notitle
# --- GRAPH g
set label 1 'Uranus' @POS
@XTICS; @YTICS
@BMARGIN; @LMARGIN
plot for [i=1:n_clones] filename(i, "Uranus")    u 1:3  w l notitle
# --- GRAPH h
set label 1 'Neptune' @POS
@XTICS; @NOYTICS
@BMARGIN; @RMARGIN
plot for [i=1:n_clones] filename(i, "Neptune")     u 1:3  w l notitle
